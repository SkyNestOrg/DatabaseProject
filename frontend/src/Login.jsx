...
// // Login.jsx (updated for useNavigate, relative endpoints, and correct redirection)
// import React, { useState } from 'react';
...
//     const endpoint = mode === 'staff' ? '/stafflogin' : '/guestlogin';
...
//             if (guestId) {
//               navigate(`/guest?guest_id=${guestId}`);
//             } else {
//               navigate('/guest');
//             }
//           } else {
...
//             console.log('User object (raw):', JSON.stringify(user));
//             console.log('Detected role:', role);
//             switch (role) {
//               case 'admin':
//                 navigate('/admin');
...
//       console.error('Login error:', error);
//       if (error.response) {
//         const serverMessage = error.response.data?.status || error.response.data?.message || 'Login failed';
//         setMessage(serverMessage);
//         setMessageType('error');
//         if (error.response.status === 401) {
//           setErrors({ 
