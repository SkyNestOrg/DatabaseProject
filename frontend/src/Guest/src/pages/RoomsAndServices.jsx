...
const RoomsAndServices = () => {
  ...
  const getRoomImage = (roomType) => {
    // Resolve assets relative to this module so Vite includes them in dev and build
    const images = {
      single: new URL('../../public/images/singleroom.jpg', import.meta.url).href,
      double: new URL('../../public/images/doubleroom.jpg', import.meta.url).href,
      deluxe: new URL('../../public/images/deluxeroom.jpeg', import.meta.url).href,
      suite: new URL('../../public/images/suite.jpeg', import.meta.url).href,
      default: new URL('../../public/images/default-room.jpeg', import.meta.url).href,
    };

    const type = (roomType || '').toLowerCase();
    if (type.includes('single')) return images.single;
    if (type.includes('double')) return images.double;
          ...
          <div key={room.type_name} className="hotel-card">
            <div className="hotel-image">
              <img 
                ...
                alt={room.type_name} 
                onError={(e) => {
                  e.target.src = new URL('../../public/images/default-room.jpeg', import.meta.url).href;
                }}
              />
