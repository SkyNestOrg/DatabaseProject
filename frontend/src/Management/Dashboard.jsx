...
function Dashboard() {
  ...
  const handleMenuItemClick = (item) => {
    if (item === "Management Profile") {
      ...
      navigate('/managementdashboard/report1');
    } else if (item === "Guest Billing Summary") {
      navigate('/managementdashboard/report2');
    } else if (item === "Service Usage Summary") {
      navigate('/managementdashboard/report3');
    } else if (item === "Monthly Revenue Report") {
      navigate('/managementdashboard/report4');
    } else if (item === "Top Used Services Summary") {
      navigate('/managementdashboard/report5');
