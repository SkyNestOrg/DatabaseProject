...
//         {/* <Route path="/frontofficelogin" element={<FrontOfficeLogin />} /> */}
...
// RoutePath.jsx (updated to fix imports and add Dashboard import)
import { BrowserRouter as Router, Routes, Route } from "react-router-dom";
...
export default function AppRoutes() {
  ...
  {/* Front Desk routes */}
  {/* Support both /frontdesk (used by login redirect) and /frontdesk/dashboard */}
