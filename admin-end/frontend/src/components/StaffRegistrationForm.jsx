...
export default function StaffRegistrationForm() {
  ...
  const roles = ['management-user', 'frontoffice-user', 'housekeeping-user', 'concierge-user'];
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Condition to not register when official role is admin-user
      if (form.official_role === 'admin-user') {
        alert('Cannot register staff with admin-user role');
        return;
      }
