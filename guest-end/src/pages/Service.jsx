...
//             'x-access-token': token  // Keep both for compatibility
//           }
//         });
...
//         <h2 className="text-2xl font-bold text-center">Create Service Request</h2>
//         <p className="text-center text-red-600">Please log in to access this feature.</p>
//       </div>
//     );
//   }
...
//     <div className="p-6 max-w-lg mx-auto bg-white rounded-xl shadow-md space-y-4">
//       <h2 className="text-2xl font-bold text-center">Create Service Request</h2>
//       <p className="text-center text-gray-600">Welcome, {username}</p>
...
//           </select>
//           {fetchingData && (
//             <p className="text-xs text-gray-500 mt-1">Loading your rooms...</p>
//           )}
//         </div>
...
//         <button
//           type="submit"
//           className="w-full bg-blue-500 text-white p-2 rounded hover:bg-blue-600 disabled:opacity-50 transition duration-200"
