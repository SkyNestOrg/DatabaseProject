...
CREATE TABLE staff_logs (
  ...
  action VARCHAR(50),
  -- Increased size for more descriptive actions
  PRIMARY KEY (log_id),
...
CREATE TABLE Guest (
  ...
  -- Increased for international numbers
  address VARCHAR(75),
...
CREATE TABLE Taxes_and_Charges (
  ...
  CONSTRAINT chk_tax CHECK (
    latest_tax_percentage BETWEEN 0 AND 100
  ),
  CONSTRAINT chk_surcharge CHECK (
    latest_surcharge_percentage BETWEEN 0 AND 100
  )
);
--@block
SELECT *
...
--@block
-- Staff_User
INSERT INTO Staff_User (username, password, official_role, branch_id)
VALUES ('john_doe', 'hashedpass1', 'Manager', 1);
INSERT INTO Staff_User (username, password, official_role, branch_id)
VALUES ('jane_smith', 'hashedpass2', 'Receptionist', 2);
INSERT INTO Staff_User (username, password, official_role, branch_id)
VALUES ('bob_brown', 'hashedpass3', 'Cleaner', 3);
--@block
-- staff_logs
INSERT INTO staff_logs (log_id, username, timestamp, action)
VALUES (1, 'john_doe', '2025-09-11 09:00:00', 'Login');
INSERT INTO staff_logs (log_id, username, timestamp, action)
VALUES (
    2,
    'jane_smith',
...
--@block
-- Guest_User
INSERT INTO Guest_User (username, password, guest_id)
VALUES ('alicew', 'guestpass1', 1);
INSERT INTO Guest_User (username, password, guest_id)
VALUES ('bobb', 'guestpass2', 2);
INSERT INTO Guest_User (username, password, guest_id)
VALUES ('charliec', 'guestpass3', 3);
--@block
-- RoomType
INSERT INTO RoomType (type_name, base_price, amenities)
VALUES ('Single', 100.00, 'Bed, TV, WiFi');
INSERT INTO RoomType (type_name, base_price, amenities)
VALUES ('Double', 150.00, '2 Beds, TV, WiFi, Mini Bar');
INSERT INTO RoomType (type_name, base_price, amenities)
VALUES (
    'Suite',
    300.00,
    'King Bed, TV, WiFi, Mini Bar, Jacuzzi'
  );
--@block
-- Room
INSERT INTO Room (
...
VALUES (1, 1, '2025-09-10', 1, 1, 1, 'Confirmed');
INSERT INTO Booking (
    booking_id,
    guest_id,
    booking_date,
...
VALUES (2, 2, '2025-09-11', 2, 2, 3, 'Pending');
INSERT INTO Booking (
    booking_id,
    guest_id,
    booking_date,
...
VALUES (3, 3, '2025-09-12', 3, 1, 2, 'Cancelled');
--@block
-- Booked_Room
...
VALUES (101, 1, 1, '2025-09-12', '2025-09-15', 'Booked');
INSERT INTO Booked_Room (
    room_number,
    booking_id,
    branch_id,
...
VALUES (102, 2, 2, '2025-09-13', '2025-09-16', 'Booked');
INSERT INTO Booked_Room (
    room_number,
    booking_id,
    branch_id,
...
VALUES (2, 2, 'Cash', 505.00, '2025-09-16 13:00:00');
INSERT INTO Payment (
    payment_reference,
    bill_id,
    payment_method,
...
VALUES (3, 3, 'None', 0.00, '2025-09-17 14:00:00');
--@block
-- Service
INSERT INTO Service (
    service_type,
...
VALUES ('Laundry', 10.00, 1, 'Available');
INSERT INTO Service (
    service_type,
    unit_quantity_charges,
    branch_id,
...
VALUES ('Room Service', 20.00, 2, 'Available');
INSERT INTO Service (
    service_type,
    unit_quantity_charges,
    branch_id,
...
VALUES ('Spa', 50.00, 3, 'Unavailable');
--@block
-- Service_Request
...
VALUES (1, 10, 1, 'Single', '2025-09-01', '2025-09-30');
INSERT INTO Discount (
    discount_id,
    percentage,
    branch_id,
...
VALUES (2, 15, 2, 'Double', '2025-09-05', '2025-09-20');
INSERT INTO Discount (
    discount_id,
    percentage,
    branch_id,
...
VALUES (3, 20, 3, 'Suite', '2025-09-10', '2025-09-25');
--@block
-- Taxes_and_Charges
INSERT INTO Taxes_and_Charges (
    revision_date,
    latest_tax_percentage,
    latest_surcharge_percentage
  )
VALUES ('2025-09-01', 10, 5);
INSERT INTO Taxes_and_Charges (
    revision_date,
    latest_tax_percentage,
    latest_surcharge_percentage
  )
VALUES ('2025-09-10', 12, 6);
INSERT INTO Taxes_and_Charges (
    revision_date,
    latest_tax_percentage,
    latest_surcharge_percentage
  )
VALUES ('2025-09-20', 15, 7);
--@block
SELECT *
FROM staff_user;
--@block
...
VALUES ('Breakfast', 25.00, 1, 'Available');
INSERT INTO Service (
    service_type,
    unit_quantity_charges,
    branch_id,
...
VALUES ('Airport Shuttle', 40.00, 1, 'Available');
...
INSERT INTO Staff_User (username, password, official_role, branch_id)
VALUES ('mike_manager', 'hash123', 'Manager', 2),
...
VALUES (
    'Deluxe',
    200.00,
    'King Bed, TV, WiFi, Mini Bar, City View'
  ),
  (
    'Executive',
    350.00,
    'King Bed, TV, WiFi, Mini Bar, Workspace, Lounge Access'
  ),
  (
    'Presidential',
    500.00,
    'Multiple Rooms, TV, WiFi, Full Kitchen, Butler Service'
  );
--@block
...
VALUES (4, '2024-12-01 14:30:00', 1, 1, 2, 'Confirmed'),
...
VALUES (103, 4, 1, '2024-12-05', '2024-12-08', 'Booked'),
...
VALUES (4, 600.00, 0.00, 60.00, 660.00, 'Pending'),
...
VALUES -- Recent pending services (Branch 1)
  (
    'Laundry',
    '2024-12-09 10:30:00',
    4,
...
VALUES (5, 'Credit Card', 1622.50, '2024-12-20 15:30:00'),
...
VALUES (25, 1, 'Deluxe', '2024-12-01', '2024-12-31'),
...
VALUES ('2024-08-01', 8, 4),
  ('2024-10-01', 10, 5),
  ('2024-12-01', 12, 6);
--@block
-- Add staff logs for activity tracking
INSERT INTO staff_logs (username, timestamp, action)
VALUES ('pamoth', '2024-12-09 09:15:00', 'Login'),
  (
    'pamoth',
    '2024-12-09 09:20:00',
    'Viewed Due Services'
  ...
  (
    'lisa_clean',
    '2024-12-08 10:00:00',
    'Completed Room Cleaning'
  );
--@block
-- Verify the data
SELECT 'Branch Count' as Table_Name,
  COUNT(*) as Count
FROM Branch
UNION ALL
SELECT 'Staff Users',
